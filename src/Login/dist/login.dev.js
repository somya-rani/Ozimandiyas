...
function getCoord(e) {
  ...
  _gsap.TweenMax.to(eyeL, 1, {
    x: -eyeLX,
    y: -eyeLY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(eyeR, 1, {
    x: -eyeRX,
    y: -eyeRY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(nose, 1, {
    x: -noseX,
    y: -noseY,
    rotation: mouthR,
  ...
  _gsap.TweenMax.to(outerEarL, 1, {
    x: outerEarX,
    y: -outerEarY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(outerEarR, 1, {
    x: outerEarX,
    y: outerEarY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(earHairL, 1, {
    x: -outerEarX,
    y: -outerEarY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(earHairR, 1, {
    x: -outerEarX,
    y: outerEarY,
    ease: _expo.Expo.easeOut
  });

  _gsap.TweenMax.to(hair, 1, {
    x: hairX,
    scaleY: hairS,
...
function onEmailInput(e) {
  ...
  if (curEmailIndex > 0) {
    if (mouthStatus == "small") {
      ...
      _gsap.TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, {
        morphSVG: mouthMediumBG,
        shapeIndex: 8,
        ease: _expo.Expo.easeOut
      });

      _gsap.TweenMax.to(tooth, 1, {
        x: 0,
        y: 0,
        ease: _expo.Expo.easeOut
      });

      _gsap.TweenMax.to(tongue, 1, {
        x: 0,
        y: 1,
        ease: _expo.Expo.easeOut
      });

      _gsap.TweenMax.to([eyeL, eyeR], 1, {
        scaleX: .85,
        scaleY: .85,
        ease: _expo.Expo.easeOut
      });
...
function resetFace() {
  ...
  _gsap.TweenMax.to([face, eyebrow], 1, {
    x: 0,
    y: 0,
    skewX: 0,
    ease: _expo.Expo.easeOut
  ...
  _gsap.TweenMax.to([outerEarL, outerEarR, earHairL, earHairR, hair], 1, {
    x: 0,
    y: 0,
    scaleY: 1,
    ease: _expo.Expo.easeOut
